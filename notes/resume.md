...
Senior full-stack/backend software engineer with 8+ years of experience building commerce, loyalty, and operational software across Rails, AWS, mobile, and web stacks. Strong track record in API design, system consolidation, cloud infrastructure, third-party integrations, data migration, CI/CD, and cross-functional technical leadership.

## Core Skills

- **Languages:** Ruby, TypeScript, SQL, Python, Dart, HTML/CSS
- **Backend:** Ruby on Rails, REST APIs, PostgreSQL, DynamoDB, service integrations, data migration
- **Cloud / Platform:** AWS (ECS, Fargate, Lambda, CloudFormation), GitHub Actions, CI/CD, Infrastructure as Code, PagerDuty
- **Full-Stack:** Flutter, Next.js, Sanity, internal operational tooling
